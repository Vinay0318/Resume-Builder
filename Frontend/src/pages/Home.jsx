...
const Home = () => {
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-100 text-gray-500">
      <Header />
      <div className="flex flex-grow items-center justify-center p-5">
        <div className="flex flex-col md:flex-row w-full max-w-6xl mx-auto bg-white shadow-2xl rounded-xl overflow-hidden">
          ...
          <div className="flex-1 p-5 md:p-10 flex flex-col justify-center text-center">
            ...
            Start building your standout resume today. Simple, efficient, and designed to help you shine.
            </p>
            <button
              onClick={() => navigate("/template")}
              type="button"
              className="w-full max-w-xs mx-auto text-white bg-gradient-to-br from-pink-300 to-orange-800 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 font-medium rounded-lg text-lg px-5 py-3.5 text-center transition duration-300"
            >
              Create my resume
            </button>
          </div>
